package com.example.matinal.video02a;
...
import es.vcarmen.video02.R;


public class Actividad02A extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    boolean pausa = false;
    //String video = "internal/movies/instagram/VID_353700714_045715_297.mp4";
    String video = Environment.getExternalStorageDirectory().getAbsolutePath()+"/Prueba.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surfaceHolder.setFixedSize(176, 144); surfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
